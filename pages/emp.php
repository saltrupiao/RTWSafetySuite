...
?>
    ...
    <head>
        ...
        <section id="nav-bar">
            <div class="topnav" id="myTopnav"> <a href="admin.php"><b> <?php echo "Return To Work Safety Suite - Employee -" . " " . $emp; ?></b></a> <a class="nav-link" href="./controller/logout.php">Logout&nbsp;</a>

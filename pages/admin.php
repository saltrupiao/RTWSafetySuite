                            ...
                            <table class="table table-striped table-hover">
                                ...
                                if ($resultTable->num_rows > 0) {
                                    while ($rowTable = $resultTable->fetch_assoc()) {
                                        ...
                                        echo '<td><form action="./controller/adminController.php" method="get"><input type="hidden" value="'.$empID.'"><button type="submit" class="btn btn-danger" value="Submit">OVERRIDE</button></form></td>';
                                        echo "</tr>";
                                    }
                                } else {
